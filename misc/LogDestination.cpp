...
/**@private*/
//DEFINE_s_int8(log_level, l, ydleMaster::YDLE_LOG_WARN, "Set the logging level 0 .. 4.");
/**@private*/
...
bool InitLoggingFromFlags() {
  ...
  if (true) { // FLAGS_syslog
    SyslogDestination *syslog_dest = new SyslogDestination(ydleMaster::YDLE_LOG_NONE);
    if (!syslog_dest->Init()) {
      delete syslog_dest;
      return false;
    }
    ...
    destination = new StdErrorLogDestination(ydleMaster::YDLE_LOG_WARN);
  }

  log_level log_level = ydleMaster::YDLE_LOG_WARN;
  switch (4) { // FLAGS_log_level
    case 0:
      // nothing is written at this level
      // so this turns logging off
      log_level = ydleMaster::YDLE_LOG_NONE;
      break;
    case 1:
      log_level = ydleMaster::YDLE_LOG_FATAL;
      break;
    case 2:
      log_level = ydleMaster::YDLE_LOG_WARN;
      break;
    case 3:
      log_level = ydleMaster::YDLE_LOG_INFO;
      break;
    case 4:
      log_level = ydleMaster::YDLE_LOG_DEBUG;
      break;
    default :
      break;
  }
...
void LogDestination::setLevel(log_level level){
	switch(level){
		case ydleMaster::YDLE_LOG_INFO:
			this->_level = ydleMaster::YDLE_LOG_INFO;
			break;
		case ydleMaster::YDLE_LOG_FATAL:
			this->_level = ydleMaster::YDLE_LOG_FATAL;
			break;
		case ydleMaster::YDLE_LOG_WARN:
			this->_level = ydleMaster::YDLE_LOG_WARN;
			break;
		case ydleMaster::YDLE_LOG_DEBUG:
			this->_level = ydleMaster::YDLE_LOG_DEBUG;
			break;
		default:
			this->_level = ydleMaster::YDLE_LOG_NONE;
			break;
	}
}
/**
